...
extern bool automove;        /* true iff user is in automove mode */
extern bool resigned;        /* true iff computer resigned */
extern bool debug;           /* true iff in debugging mode */
extern bool print_debug;     /* true iff we print debugging stuff */
extern char print_vmap;      /* the map-printing mode */
extern bool trace_pmap;      /* true if we are tracing pmaps */
extern int win;              /* set when game is over - not a bool */
